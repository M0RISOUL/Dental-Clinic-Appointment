        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-16 relative">
                ...
                <h1 class="text-5xl font-bold text-gray-900 mb-6">
                    ...
                    <span class="block text-teal-600 mt-2">{{ $settings['about_hero_subtitle'] }}</span>
                </h1>
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden mb-20">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="lg:w-1/2 relative">
                        <img src="{{ asset($settings['about_clinic_image']) }}"
                             alt="Clinic Image"
                        ...
                        <div class="absolute bottom-4 left-4 right-4 flex justify-around">
                            <div class="bg-white/90 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                                <div class="text-2xl font-bold text-teal-600">{{ $settings['about_years_experience'] }}</div>
                                <div class="text-sm text-gray-600">Years Experience</div>
                            </div>
                            <div class="bg-white/90 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                                <div class="text-2xl font-bold text-teal-600">{{ $settings['about_happy_patients'] }}</div>
                    ...
                    <div class="lg:w-1/2 p-8 lg:p-12">
                        ...
                        <p class="text-gray-600 mb-8 leading-relaxed">
                            {{ $settings['about_main_description'] }}
                        </p>
                        ...
                        <div class="space-y-4 mb-8">
                            <div class="flex items-center p-4 bg-teal-50 rounded-xl hover-card">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-800 mb-1">{{ $settings['about_feature1_title'] }}</h3>
                                    <p class="text-gray-600">{{ $settings['about_feature1_description'] }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center p-4 bg-teal-50 rounded-xl hover-card">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-800 mb-1">{{ $settings['about_feature2_title'] }}</h3>
                                    <p class="text-gray-600">{{ $settings['about_feature2_description'] }}</p>
                                </div>
                            </div>
                            <div class="flex items-center p-4 bg-teal-50 rounded-xl hover-card">
                                <div class="flex-shrink-0 mr-4">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-800 mb-1">{{ $settings['about_feature3_title'] }}</h3>
                                    <p class="text-gray-600">{{ $settings['about_feature3_description'] }}</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="grid md:grid-cols-3 gap-8 mb-20">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover-card">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-3">{{ $settings['about_service1_title'] }}</h3>
                    <p class="text-gray-600">{{ $settings['about_service1_description'] }}</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover-card">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-3">{{ $settings['about_service2_title'] }}</h3>
                    <p class="text-gray-600">{{ $settings['about_service2_description'] }}</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover-card">
                    ...
                    <h3 class="text-xl font-bold text-gray-800 mb-3">{{ $settings['about_service3_title'] }}</h3>
                    <p class="text-gray-600">{{ $settings['about_service3_description'] }}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-12 mb-20">
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div class="testimonial-card bg-gradient-to-br from-teal-50 to-white p-8 rounded-2xl shadow-lg">
                        <div class="flex items-center mb-6">
                            <div class="w-16 h-16 bg-teal-200 rounded-full flex items-center justify-center">
                                <span class="text-teal-700 font-bold text-2xl">{{ substr($settings['about_testimonial1_name'], 0, 1) }}</span>
                            </div>
                            <div class="ml-4">
                                <h4 class="text-xl font-semibold text-gray-900">{{ $settings['about_testimonial1_name'] }}</h4>
                                <p class="text-teal-600">{{ $settings['about_testimonial1_role'] }}</p>
                            </div>
                        </div>
                        <p class="text-gray-600 text-lg italic leading-relaxed">
                            "{{ $settings['about_testimonial1_text'] }}"
                        </p>
                    </div>
                    ...
                    <div class="testimonial-card bg-gradient-to-br from-teal-50 to-white p-8 rounded-2xl shadow-lg">
                        <div class="flex items-center mb-6">
                            <div class="w-16 h-16 bg-teal-200 rounded-full flex items-center justify-center">
                                <span class="text-teal-700 font-bold text-2xl">{{ substr($settings['about_testimonial2_name'], 0, 1) }}</span>
                                </div>
                            <div class="ml-4">
                                <h4 class="text-xl font-semibold text-gray-900">{{ $settings['about_testimonial2_name'] }}</h4>
                                <p class="text-teal-600">{{ $settings['about_testimonial2_role'] }}</p>
                            </div>
                        </div>
                        <p class="text-gray-600 text-lg italic leading-relaxed">
                            "{{ $settings['about_testimonial2_text'] }}"
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="relative px-8 py-16 text-center">
                    <div class="max-w-3xl mx-auto">
                        ...
                        <p class="text-teal-50 text-lg mb-10 leading-relaxed">
                            {{ $settings['about_cta_description'] }}
                        </p>
            ...
            <div class="mt-20 mb-16">
                <div class="text-center mb-12">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">{{ $settings['about_why_choose_title'] }}</h2>
                    <div class="w-24 h-1 bg-teal-500 mx-auto mb-6"></div>
                    <p class="text-gray-600 max-w-2xl mx-auto">
                        {{ $settings['about_why_choose_description'] }}
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-4 gap-8">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover-card">
                        ...
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">{{ $settings['about_feature_quality_title'] }}</h3>
                        <p class="text-gray-600">{{ $settings['about_feature_quality_description'] }}</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover-card">
                        ...
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">{{ $settings['about_feature_timely_title'] }}</h3>
                        <p class="text-gray-600">{{ $settings['about_feature_timely_description'] }}</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover-card">
                        ...
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">{{ $settings['about_feature_facility_title'] }}</h3>
                        <p class="text-gray-600">{{ $settings['about_feature_facility_description'] }}</p>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg hover-card">
                        ...
                        <h3 class="text-lg font-semibold text-gray-800 mb-2">{{ $settings['about_feature_staff_title'] }}</h3>
                        <p class="text-gray-600">{{ $settings['about_feature_staff_description'] }}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="flex items-center p-6 bg-teal-50 rounded-xl hover-card">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">{{ $settings['about_contact_address'] }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-6 bg-teal-50 rounded-xl hover-card">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">{{ $settings['about_contact_phone'] }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-6 bg-teal-50 rounded-xl hover-card">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">{{ $settings['about_contact_hours'] }}</p>
                        </div>
                    </div>
                </div>
            </div>
