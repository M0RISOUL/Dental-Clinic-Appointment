    ...
    <div class="relative overflow-hidden bg-gradient-to-b from-teal-50 to-white py-20">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                <!-- Address Card -->
                <div
                    class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 
                            transform hover:-translate-y-2 hover:bg-gradient-to-b hover:from-white hover:to-teal-50">
                    <div
                        class="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-teal-400 to-teal-500 
                ...
                <div
                    ...
                    <p class="text-gray-600 text-center font-light">{{ $settings['contact_email'] }}</p>
                ...
                <div
                    ...
                    <p class="text-gray-600 text-center font-light">{{ $settings['contact_phone'] }}</p>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h4 class="font-semibold text-lg mb-1">Emergency Contact</h4>
                                        <p class="text-teal-100 font-light">{{ $settings['contact_emergency_phone'] }}</p>
                                </div>
                            </div>
                            ...
                            <div class="pt-8 border-t border-teal-400 border-opacity-30">
                                ...
                                <div class="flex space-x-4">
                                    <a href="#"
                                        class="bg-teal-400 bg-opacity-20 p-3 rounded-lg hover:bg-opacity-30 
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300
                    ...
                    <div class="flex items-start mb-4">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $settings['contact_faq1_question'] }}</h3>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300
                    ...
                    <div class="flex items-start mb-4">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $settings['contact_faq2_question'] }}</h3>
                            <p class="text-gray-600 font-light">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300
                    ...
                    <div class="flex items-start mb-4">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $settings['contact_faq3_question'] }}</h3>
                            <p class="text-gray-600 font-light">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300
                    ...
                    <div class="flex items-start mb-4">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $settings['contact_faq4_question'] }}</h3>
                            <p class="text-gray-600 font-light">
                                {{ $settings['contact_faq4_answer'] }}
                            </p>
                        </div>
                    </div>
                </div>
