                                ...
                                <div class="flex items-center">
                                    <div class="h-10 w-10 flex-shrink-0">
                                        @if($patient->image_path)
                                            <img class="h-10 w-10 rounded-full object-cover border border-teal-300" src="{{ $patient->image_path ? asset(path: 'storage/' . $patient->image_path) : asset('images/default-avatar.png') }}" alt="{{ $patient->firstname }}">
                                        @else
