...
<span class="ml-1">{{ $appointment->updated_at ? $appointment->updated_at->format('M d, Y h:i A') : 'Not available' }}</span>
                                    </div>
                                @else
                                    @php
...
<div class="text-sm text-teal-600">Last Updated: {{ $appointment->updated_at ? $appointment->updated_at->format('M d, Y h:i A') : 'Not available' }}</div>                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
