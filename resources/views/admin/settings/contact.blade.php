<x-sidebar-layout>
    ...
    <div class="fixed bottom-6 right-6" x-data="{ showHelp: false }">
        <button @click="showHelp = !showHelp" class="bg-teal-500 text-white p-3 rounded-full shadow-lg hover:bg-teal-600 transition-all duration-300 flex items-center justify-center">
            <svg x-show="!showHelp" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
            </svg>
            <svg x-show="showHelp" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Help Tooltip -->
        <div x-show="showHelp" @click.away="showHelp = false" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 transform translate-y-0" x-transition:leave-end="opacity-0 transform translate-y-2" class="absolute bottom-16 right-0 w-64 bg-white rounded-lg shadow-xl p-4 border border-teal-100">
            ...
            <ul class="text-sm text-gray-600 space-y-2">
                <li class="flex items-start">
                    <svg class="w-4 h-4 text-teal-500 mt-0.5 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span>Use the tabs to navigate between contact info and FAQs</span>
                </li>
                <li class="flex items-start">
                    <svg class="w-4 h-4 text-teal-500 mt-0.5 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span>Click on FAQ headers to expand and edit them</span>
                </li>
                <li class="flex items-start">
                    <svg class="w-4 h-4 text-teal-500 mt-0.5 mr-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span>Use &lt;br&gt; in opening hours for line breaks</span>
                </li>
            </ul>
        </div>
    </div>
