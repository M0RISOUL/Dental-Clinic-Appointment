    ...
    <div class="py-12">
        ...
        @else
            <div class="flex flex-col lg:flex-row items-start justify-center">
                 <div class="bg-white shadow-lg lg:rounded-r-lg max-w-xs w-full lg:w-1/4 mb-5 mt-4 h-96 lg:block  top-0">
                                                    ...
                                                    <div class="m-2">
                                                        <div class="job-card group mx-2 mt-5 mb-5 grid max-w-screen-md grid-cols-12 space-x-8 overflow-hidden rounded-lg border py-8 text-gray-700 shadow transition hover:shadow-lg sm:mx-auto"
                                                            ...
                                                            <div
                                                                ...
                                                                <p class="text-sm flex-grow">{{ Str::words($job->description, 6, '...') }}</p>
                                                                <div
